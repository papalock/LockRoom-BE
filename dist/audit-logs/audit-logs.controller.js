...
let AuditLogsController = class AuditLogsController {
    ...
    createLoginLog(user_id, organization_id, type) {
        return this.auditLogsService.create(null, user_id, organization_id, type);
    }
    createDocumentLog(file_id, user_id, organization_id, type) {
        return this.auditLogsService.create(file_id, user_id, organization_id, type);
    }
